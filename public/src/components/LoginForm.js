        ...
        <div >
          ...
          <form id="homePage-form">
            <div className="form-group">
              <input type="text" className="form-control" id="exampleInputEmail1" placeholder="用户名" ref="username" onFocus={this.handleFocus.bind(this)}/>
            </div>
            <div className="form-group">
              <input type="password" className="form-control" id="exampleInputPassword1" placeholder="密码" ref="password" onFocus={this.handleFocus.bind(this)}/>
